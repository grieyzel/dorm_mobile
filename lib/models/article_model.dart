...
List<ArticleModel> getExploreByTopic() {
  ...
  discoverList.add(
    ArticleModel(
        imageAsset: TopicImage.travel, title: 'Travel', subtitle: '220'),
  );
  discoverList.add(
    ArticleModel(
        imageAsset: TopicImage.productivity,
        title: 'Productivity',
        subtitle: '220'),
  );
  discoverList.add(
    ArticleModel(
        imageAsset: TopicImage.nature, title: 'Nature', subtitle: '220'),
  );
  discoverList.add(
    ArticleModel(
        imageAsset: TopicImage.sports, title: 'Sports', subtitle: '220'),
  );
  discoverList.add(
    ArticleModel(
        imageAsset: TopicImage.education, title: 'Education', subtitle: '220'),
  );
  discoverList.add(
  ...
  discoverList.add(
    ArticleModel(
        imageAsset: TopicImage.business, title: 'Business', subtitle: '220'),
  );
  return discoverList;
}
...
List<ArticleModel> getWriterList() {
  ...
  writerList.add(
    ArticleModel(
        authorImage: AuthorImage.authElina, authorName: AuthorName.authElina),
  );
  writerList.add(
    ArticleModel(
        authorImage: AuthorImage.authChris, authorName: AuthorName.authChris),
  );
  writerList.add(
    ArticleModel(
        authorImage: AuthorImage.authNolan, authorName: AuthorName.authNolan),
  );
  writerList.add(
    ArticleModel(
        authorImage: AuthorImage.authChristina,
  ...
  writerList.add(
    ArticleModel(
        authorImage: AuthorImage.authStuart, authorName: AuthorName.authStuart),
  );
