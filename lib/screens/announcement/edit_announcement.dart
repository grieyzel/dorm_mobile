...
class EditAnnouncementScreen extends StatefulWidget {
  ...
  EditAnnouncementScreen({required this.announcementData});
...
class _EditAnnouncementScreenState extends State<EditAnnouncementScreen> {
  ...
  void initState() {
    super.initState();
    titleController.text = widget.announcementData["title"] ?? "";
    descriptionController.text = widget.announcementData["description"] ?? '';
    _selectedStatus = widget.announcementData["status"] ?? "Active";
  }
  ...
  Future<void> _updateAnnouncement() async {
    ...
    var request = http.MultipartRequest(
      "POST",
      Uri.parse('$BaseUrl/api/announcements/${widget.announcementData["id"]}'),
    );
          ...
          children: [
            ...
            Stack(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: (_image != null
                        ...
                        : widget.announcementData["image"] != null
                            ? DecorationImage(
                                image: NetworkImage(
                                    widget.announcementData["image"]),
                                fit: BoxFit.cover,
                              )
                            : null),
                  ),
                ...
                if (_image != null || widget.announcementData["image"] != null)
                  Positioned(
                    bottom: 10,
                    right: 10,
