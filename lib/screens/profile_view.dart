...
class _ProfileViewState extends State<ProfileView> {
    ...
    return Row(
      children: [
        ...
        GestureDetector(
          ...
          child: Chip(
            side: BorderSide(
                style: BorderStyle.solid, color: scribblrPrimaryColor),
            label: Text(
              _isSelected ? 'Following' : 'Follow',
              style: TextStyle(
                  fontSize: 12,
                  color: _isSelected ? scribblrPrimaryColor : Colors.white),
            ),
  ...
  Divider buildDivider() {
    return Divider(
        thickness: appStore.isDarkMode ? 0.4 : 0.2, color: dividerDarkColor);
  }
  ...
  Column buildMoreInfoSection() {
    return Column(
      ...
      children: [
        ...
        10.height,
        buildInfoRow(
            Ionicons.information_circle_outline, 'Joined Since March, 2024'),
      ],
    );
  }
