      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            5.height,
            Text("Don't worry. Only you can see your personal data. No one else will be able to see it.", style: secondarytextStyle()),
            15.height,
            Center(
              child: Stack(
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: _image == null ? null : DecorationImage(image: FileImage(File(_image!.path)), fit: BoxFit.fitWidth),
